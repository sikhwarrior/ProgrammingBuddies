...
using ProgrammingBuddies.Application.Subscriptions.Commands.CancelSubscription;
...
using SubscriptionType = ProgrammingBuddies.Contracts.Common.SubscriptionType;
